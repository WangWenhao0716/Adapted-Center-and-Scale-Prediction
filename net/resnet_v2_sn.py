...
from net.devkit.core import (init_dist, broadcast_params, average_gradients, load_state_ckpt, load_state, save_checkpoint, LRScheduler)
import torch
...
def resnetv2sn18(pretrained = True, **kwargs):
...
def resnetv2sn34(pretrained = True, **kwargs):
...
def resnetv2sn152(pretrained = True, **kwargs):
